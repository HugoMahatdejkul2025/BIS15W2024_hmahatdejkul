...
ui <- fluidPage(
  selectInput("x", "Select X Variable", choices = c("birds","river fishes","lizards","mammals"), 
              selected = "birds"),
...
#```{r}
ui <- dashboardPage(dashboardHeader(title="penguins"),dashboardSidebar(disable=T),dashboardBody(
